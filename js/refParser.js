...
var FilterKitab = [
  [/^G[en]\D*/i,      "Gen"],[/^K[e]?j\D*/i,      "Gen"],       //Kej.  "Ge Gen Gen Kj Kej" 
  [/^Ex\D*/i,      "Exod"], [/^K[e]?l\D*/i,      "Exod"],       //Kel.  "Ex Kl Kel"
  [/^L[ev]\D*/i,      "Lev"],[/^I[ma]\D*/i,      "Lev"],        //Ima.  "Le Lv Lev Lve Im Ia Ima Iam"
  [/^Nu\D*/i,      "Num"],[/^B[il]\D*/i,      "Num"],           //Bil.  "Nu Bi Bl Bil"
  [/^D[eu]\D*/i,      "Deut"],[/^U[la]\D*/i,      "Deut"],      //Ula.  "De Du Deu Due Ul Ua Ula Ual"
  [/^J[o]s\D*/i,      "Josh"],                                  //Yos.  "Jos"
  [/^Y[o]s\D*/i,      "Josh"],[/^Ys\D*/i,      "Josh"],         //Yos.  "Ys Yos"
  [/^Judg\D*/i,      "Judg"],                                   //Hak.  "Judge"
  [/^Hk\D*/i,      "Judg"],[/^Hak\D*/i,      "Judg"],           //Hak.  "Hk Hak"
  [/^R[ut]\D*/i,      "Ruth"],                                  //Rut.  "Ru Rt Rut Rtu"
  [/^1\s*S[am]\D*/i,    "1Sam"],                                //1Sam. "1Sa 1Sm 1Sam 1Sma"   
  [/^2\s*S[am]\D*/i,    "2Sam"],                                //2Sam. "2Sa 2Sm 2Sam 2Sma"   
  [/^1\s*Kg\D*/i,  "1Kgs"],[/^1\s*R\D*/i,  "1Kgs"],             //1Raj. "1Kg 1R"
  [/^2\s*Kg\D*/i,  "2Kgs"],[/^2\s*R\D*/i,  "2Kgs"],             //2Raj. "1Kg 1R"
  [/^1\s*C[hr]\D*/i,  "1Chr"],[/^1\s*T[aw]\D*/i,  "1Chr"],      //1Taw. "1Ch 1Cr 1Chr 1Crh 1Ta 1Tw 1Taw 1Taw"
  [/^2\s*C[hr]\D*/i,  "2Chr"],[/^2\s*T[aw]\D*/i,  "2Chr"],      //2Taw. "2Ch 2Cr 2Chr 2Crh 2Ta 2Tw 2Taw 2Taw"
  [/^E[z]?r\D*/i,      "Ezra"],                                 //Ezr.  "Ezr"
  [/^N[eh]\D*/i,      "Neh"],                                   //Neh.  "Ne Nh Neh Nhe"
  [/^E?st\D*/i,      "Esth"],                                   //Est.  "Est"
  [/^J[o]?b\D*/i,      "Job"],[/^Ay[u]?b\D*/i,      "Job"],     //Ayb.  "Jb Job Ayb Ayub"
  [/^P[s]\D*/i,      "Ps"],[/^Ma?z\D*/i,      "Ps"],            //Maz.  "Ps Mz Maz"
  [/^P[r]?o\D*/i,      "Prov"],[/^A[m]?s\D*/i,      "Prov"],    //Ams.  "Po Pro As Ams"
  [/^E[cc]\D*/i,      "Eccl"],                                  //Pkh.  "Ec Ecc"
  [/^Pkh\D*/i,      "Eccl"], [/^Pen\D*/i,      "Eccl"],         //Pkh.  "Pkh Pen"
  [/^S[o]n\D*/i,      "Song"],[/^Kid\D*/i,      "Song"],        //Kid.  "Son Kid"
  [/^I[s?a]\D*/i,      "Isa"],[/^Yes\D*/i,      "Isa"],         //Yes.  "Is Isa Yes"
  [/^J[er]\D*/i,      "Jer"],[/^Ye[r?]\D*/i,      "Jer"],       //Yer.  "Je Jr Jer Jre Yer" 
  [/^L[am]\D*/i,      "Lam"],[/^R[a]t\D*/i,      "Lam"],        //Rat.  "La Lm Lam Lma Rat"
  [/^E[zek]\D*/i,      "Ezek"],[/^Y[ehz]\D*/i,      "Ezek"],    //Yeh.  "Yel Yeh Yz Yh Yhz Yehz Yehez Ez Ee Ek Eek Ezk Ezek"
  [/^D[a]?n\D*/i,      "Dan"],                                  //Dan.  "Dn Dan"
  [/^H[os]\D*/i,      "Hos"],                                   //Hos.  "Ho Hs Hos Hso"
  [/^Joe\D*/i,      "Joel"],                                    //Yoe.  "Joe" 
  [/^Yl\D*/i,      "Joel"],[/^Yoe\D*/i,      "Joel"],           //Yoe.  "Yl Yoe" 
  [/^A[m?o]\D*/i,      "Amos"],                                 //Amo.  "Ao Am Amo"
  [/^O[ba]\D*/i,      "Obad"],                                  //Oba.  "Ob Oa Oba Oab"
  [/^Jo?[n]a\D*/i,      "Jonah"],[/^Yu?[n]\D*/i,      "Jonah"], //Yun.  "Jona Yn Yun" 
  [/^Mi\D*/i,      "Mic"],                                      //Mik.  "Mi"
  [/^Nah?\D*/i,      "Nah"],                                    //Nah.  "Na Nah"
  [/^Ha?[b]\D*/i,      "Hab"],                                  //Hab.  "Hb Hab"
  [/^Ze[p]\D*/i,      "Zeph"],[/^Ze[f]\D*/i,      "Zeph"],      //Zef.  "Zep Zef"
  [/^H?a[g]\D*/i,      "Hag"],                                  //Hag.  "Hag"
  [/^Z[e]?c\D*/i,      "Zech"],[/^Z[a]?k\D*/i,      "Zech"],    //Zak.  "Zec Zak"
  [/^Ma?l\D*/i,      "Mal"],                                    //Mal.  "Mal"
  [/^Ma?t?t\D*/i,    "Matt"],                                   //Mat.  "Mt Mat" 
  [/^Ma?[rk]\D*/i,  "Mark"],                                    //Mar.  "Mar Mak"
  [/^L[uk]\D*/i,      "Luke"],                                  //Luk.  "Lu Lk Luk Lku"
  [/^Jo?[hn]\D*/i,  "John"],[/^Yo?[h]\D*/i,  "John"],           //Yoh.  "Joh Jon John Jonh Yoh"
  [/^Act\D*/i,      "Acts"],                                    //Kis.  "Act"   
  [/^Kis*/i,      "Acts"],[/^Ras?/i,      "Acts"],              //Kis.  "Kis Ras" 
  [/^R[om]\D*/i,    "Rom"],                                     //Rom.  "Ro Rm Rom Rmo"
  [/^1\s*C\D*/i,    "1Cor"],[/^1\s*Kor\D*/i,    "1Cor"],        //1Kor. "1C 1Kor"
  [/^2\s*C\D*/i,    "2Cor"], [/^2\s*Kor\D*/i,    "2Cor"],       //2Kor. "2C 2Kor"
  [/^Gal\D*/i,      "Gal"],                                     //Gal.  "Gal"
  [/^Eph\D*/i,      "Eph"],[/^Ef[ef]\D*/i,      "Eph"],         //Efe.  "Eph Eff Efe" 
  [/^Phlp\D*/i,      "Phil"],[/^P[h]il?i\D*/i,      "Phil"],    //Flp.  "Phlp Phili"
  [/^Flp\D*/i,      "Phil"],[/^Fil[i]\D*/i,      "Phil"],       //Flp.  "Flp Fili"
  [/^C\D*/i,      "Col"],[/^Kol\D*/i,      "Col"],              //Kol.  "C  Kol"
  [/^1\s*Th\D*/i,    "1Thess"],[/^1\s*Te\D*/i,    "1Thess"],    //1Tes. "1Th 1Te"
  [/^2\s*Th\D*/i,    "2Thess"],[/^2\s*Te\D*/i,    "2Thess"],    //2Tes. "2Th 2Te"
  [/^1\s*T[im]\D*/i,  "1Tim"],                                  //1Tim. "1Ti 1Tm 1Tim 1Tmi"
  [/^2\s*T[im]\D*/i,  "2Tim"],                                  //2Tim. "2Ti 2Tm 2Tim 2Tmi"
  [/^Tit\D*/i,      "Titus"],                                   //Tit.  "Tit"
  [/^Ph\w*m\D*/i,    "Phlm"],[/^Phil?e\D*/i,    "Phlm"],        //Flm.  "Phlm Phile"
  [/^Fl\w*m\D*/i,    "Phlm"],[/^Fi[l]\w*e\D*/i,    "Phlm"],     //Flm.  "Flm File"
  [/^Heb\D*/i,      "Heb"],[/^Ibr\D*/i,      "Heb"],            //Ibr.  "Heb Ibr"
  [/^J[ams]\D*/i,    "Jas"],[/^Y?ak\D*/i,    "Jas"],            //Yak.  "Ja jm js jam jas jsm Yak"
  [/^1\s*Pet\D*/i,    "1Pet"],[/^1\s*Ptr\D*/i,    "1Pet"],      //1Pet. "1Pet 1Ptr"
  [/^2\s*Pet\D*/i,    "2Pet"],[/^2\s*Ptr\D*/i,    "2Pet"],      //2Pet. "2Pet 2Ptr"
  [/^1\s*J\D*/i,    "1John"],[/^1\s*Yo?[h]\D*/i,    "1John"],   //1Yoh. "1J  1Yoh"
  [/^2\s*J\D*/i,    "2John"],[/^2\s*Yo?[h]\D*/i,    "2John"],   //2Yoh. "2J  2Yoh"
  [/^3\s*J\D*/i,    "3John"],[/^3\s*Yo?[h]\D*/i,    "3John"],   //3Yoh. "3J  3Yoh"
  [/^Jud\D*/i,      "Jude"],[/^Yu\D*/i,      "Jude"],           //Yud.  "Jud Yu"
  [/^R[ev]\D*/i,    "Rev"],                                     //Wah.  "Re Rv Rev Rve"
  [/^W[ah]\D*/i,    "Rev"], [/^Why\D*/i,    "Rev"]              //Wah.  "Wa Wh Wah Wha Why"
];
        ...
        case 2:
            ...
            if (KPA[1].indexOf("-") !== -1) {
              ...
              for (var i = 0; i < _ayat.length; ++i) {
                if(_ayat[i]>BCV[osisName][Alkitab.pasal-1]){_ayat[i] = BCV[osisName][Alkitab.pasal-1]}
              }
              Alkitab.ayat = _ayat;
